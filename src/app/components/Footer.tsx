...
import { MapPin, Phone, Mail, Leaf, Instagram, Facebook, Youtube, ArrowRight } from "lucide-react";
          ...
          <div>
            ...
            <ul className="space-y-3">
              {PROKLIM_LINKS.map(item => (
                <li key={item}>
                  <Link to="/peta" className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-2 group">
